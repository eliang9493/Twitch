...
public class RecommendationService {
    ...
    public Map<String, List<Item>> recommendItemsByDefault() throws RecommendationException{
        Map<String, List<Item>> recommendationItemMap = new HashMap();
        List<Game> topGames;
        ...
        for (ItemType type : ItemType.values()) {
            recommendationItemMap.put(type.toString(), recommendByTopGames(type, topGames));
        }
        return recommendationItemMap;
    }
    ...
    // Keys of the map are [Stream, Video, Clip]. Each key is corresponding to a list of Items objects,
